<ion-grid class="ion-padding">
    <ion-row>
        ...
        <ion-col size="12" offset-md="1" size-md="6" offset-md="2" size-lg="6" offset-md="2" size-xl="6" class="ion-padding">
            <form id="regForm" action="" class="ion-padding" method="post">
                ...
                <div class="tab">
                    ...
                    <ion-item lines="none" class="ion-padding-top">
                        <ion-radio-group value="" name="guestsdedicated" require>
                            <ion-list-header>
                    ...
                    <ion-item lines="none" class="ion-padding-top">
                        <ion-radio-group value="" name="usercomapany" require>
                            <ion-list-header>
                ...
                <ion-footer>
                    <div>
                        <ion-button type="submit" class="ion-float-left" id="prevBtn" onclick="nextPrev(-1)">Back</ion-button>
                        <ion-button type="submit" class="ion-float-right" id="nextBtn" onclick="nextPrev(1)">Next</ion-button>
                    </div>
                </ion-footer>
