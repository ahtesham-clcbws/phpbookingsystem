...
const a = new WeakMap(),
  ...
  f = (o, n) =>
    customElements.whenDefined(o).then(() => {
      const t = document,
        e = t.createElement(o);
      return (
        e.classList.add("overlay-hidden"),
        Object.assign(e, n),
        g(t).appendChild(e),
        e.componentOnReady()
      );
  ...
  y = (o) => {
    0 === e &&
      ...
      o.addEventListener("ionBackButton", (n) => {
        ...
        e &&
          e.backdropDismiss &&
          n.detail.register(t, () => e.dismiss(void 0, A));
      }),
  ...
  h = (o, n, t) => {
    const e = ((o, n) => (
      ...
      Array.from(o.querySelectorAll(n)).filter((o) => o.overlayIndex > 0)
    ))(o, n);
  ...
  k = async (t, e, s, i, r, c, u) => {
    ...
    t.presented = !1;
    try {
      t.willDismiss.emit({ data: e, role: s });
      const d = o(t),
        p = t.leaveAnimation ? t.leaveAnimation : n.get(i, "ios" === d ? r : c);
      "gesture" !== s && (await w(t, p, t.el, u)),
        t.didDismiss.emit({ data: e, role: s }),
        a.delete(t);
    } catch (d) {
      console.error(d);
    }
  ...
  w = async (o, t, e, s) => {
    ...
    (o.animated && n.getBoolean("animated", !0)) || i.duration(0),
      o.keyboardClose &&
        i.beforeAddWrite(() => {
